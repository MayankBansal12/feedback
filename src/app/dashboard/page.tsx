...
export default function Dash() {
  return (
    <div className="flex flex-col dark:bg-dark-secondary px-10 w-full h-full dark:text-white">
      <h1 className="py-10 font-semibold text-xl">dashboard</h1>
      <div className="flex flex-col justify-center items-center gap-8 h-2/3">
        <h2 className="text-center text-xl">
          <p>
            this week you had <span className="font-semibold">1000</span>{" "}
            feedbacks
          </p>
          <p>
            on your <span className="font-semibold">social</span> app.
          </p>
        </h2>
