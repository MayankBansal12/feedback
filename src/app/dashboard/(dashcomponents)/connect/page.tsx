    ...
    <div className="flex flex-col dark:bg-dark-secondary px-10 py-10 w-full h-full dark:text-white">
      ...
      <div className="flex flex-col justify-center items-center gap-5 py-10 w-full">
        <input
          ...
          className="bg-light-primary dark:bg-accent-darkinput px-4 py-1 border-l-2 border-l-black dark:border-l-[#ffffff] w-96 text-md text-white outline-none hover:outline focus:outline"
        />
        <input
          type="text"
