  ...
  const saveProfile = async () => {
    try {
      ...
      toast({
        title: "oops! couldn't update!",
        description:
          error.response.data.message.toLowerCase() || "refresh and try again!",
      });
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="flex flex-col dark:bg-dark-secondary px-10 w-full h-full dark:text-white">
      <div className="flex justify-between items-center gap-4">
        <h1 className="pt-1 pb-3 font-semibold text-xl">settings</h1>
      </div>

      <Tabs defaultValue={tabParam ?? "usage"} className="w-full">
        <TabsList className="grid grid-cols-3 bg-transparent w-1/3">
        ...
        <TabsContent value="usage" className="relative">
          <ChartContainer
            config={chartConfig}
            className="opacity-45 w-2/3 h-2/3"
          >
          ...
          <div className="top-[40%] left-[25%] absolute text-lg">
            usage chart & metrics coming soon...
          </div>
        </TabsContent>
          ...
          <Card className="dark:bg-dark-primary">
            ...
            <CardContent className="space-y-2">
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  />
                  <Button
                    onClick={() => handleCopy(user?.userId ?? "", "clientId")}
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <Button
                    onClick={() =>
                      handleCopy(user?.clientSecret ?? "", "clientSecret")
                    }
                    className="bg-light-primary hover:bg-light-secondary dark:hover:bg-dark-secondary dark:bg-dark-primary px-2 h-full transition-all"
                  >
            ...
            <CardFooter>
              <div className="opacity-70 text-sm">
                if your client secret is compromised and needs to be changed,
                contact our support
              </div>
            </CardFooter>
          </Card>
