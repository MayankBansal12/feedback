      ...
      <div className="flex flex-col justify-between items-center bg-white dark:bg-dark-secondary min-h-screen font-default">
        <div className="flex flex-col items-center h-screen">
          <div className="space-y-4 px-4 md:px-32 py-10 md:py-20 w-full text-black text-center text-xl md:text-3xl dark:text-white">
            ...
            <p className="py-3">
              introducing <span className="font-bold">feedback.</span> an easy way to
              collect and manage
              <br /> user feedbacks.
            </p>
          </div>
        ...
        <div className="flex flex-cols justify-center items-center bg-dark-primary mt-64 py-2 w-full">
          <div className="border-dark-primary mx-4 lg:mx-48 -mt-52 border rounded-xl w-full">
            <div className="bg-light-primary text-black rounded-t-md py-4 p-3 text-center text-xl md:text-3xl">
              <p>here are the top 5 reasons to chose us ;)</p>
            </div>
            <div className="space-y-4 bg-light-secondary text-black rounded-b-md px-4 lg:px-24 py-4 lg:py-20 text-md md:text-xl">
              <div className="flex">
              ...
              <div className="flex">
                <span className="px-4">⭐</span>
                <p>if you wanna track your site ratings, you&apos;ll love us.</p>
              </div>
              <div className="flex">
                <span className="px-4">⭐</span>
                <p>
                  launched a new feature and wanna know user&apos;s feedback, don&apos;t worry just create a new form and place on your website and we&apos;ll take care of rest!
                </p>
              </div>
              <div className="flex">
                <span className="px-4">⭐</span>
                <p>
                  we&apos;ll take care of your users feedbacks and reviews; so you just focus on your
                  upgrading your site or app.
                </p>
              </div>
              <div className="flex">
                <span className="px-4">⭐</span>
                <p>
                  track all your user analytics and reviews on the dashboard. you will exactly know what and where to improve, give a try!
                </p>
              </div>
            </div>

            <div className="flex flex-col gap-2 justify-center items-center bg-dark-primary text-white my-20 py-2 w-full">
              <p>we are going live probably next week!</p>
              <h2 className="text-xl">be the first one to know and try out our product!</h2>
              <button className="bg-accent-link hover:bg-accent-buttonhover transition-all p-1 px-4 my-2 rounded-full text-white" onClick={() => router.replace("/dashboard")}>join waitlist</button>
            </div>

            <div className="flex flex-col gap-2 items-center justify-center mt-20 mb-10">
            ...
            <div className="flex gap-6 py-4 text-left">
              ...
              <Link className="text-accent-link hover:text-accent-buttonhover transition-all" href="/dashboard">join waitlist</Link>
            </div>
          </div>
        </div>
      </div>
